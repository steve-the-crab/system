...
# cryptsetup close encrypted_physical_volume || true
# umount /dev/mapper/$volume_group-$logical_volume || true
# umount /mnt || true
# umount /dev/mapper/encrypted_physical_volume || true
# umount /dev/vda2 || true
# umount /dev/vda1 || true
# umount /dev/vda || true
...
echo "$password" | cryptsetup open $rootpart encrypted_physical_volume
